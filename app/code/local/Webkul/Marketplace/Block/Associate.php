...
class Webkul_Marketplace_Block_Associate extends Mage_Customer_Block_Account_Dashboard
{
	...
	protected function _prepareLayout() {
        ...
        $grid_per_page_values = explode(",",Mage::getStoreConfig('catalog/frontend/grid_per_page_values',Mage::app()->getStore()));
        $arr_perpage = array();
    ...
    public function getAllowedSets(){
		$entityTypeId = Mage::getModel('eav/entity')
                ...
                ->getTypeId();
        $data=array();
        $allowed=explode(',',Mage::getStoreConfig('marketplace/marketplace_options/attributesetid',Mage::app()->getStore()));
