			...
			try {
	            ...
	            if(count($collection_product))
	            {
					if(empty($errors)){
						...
						Mage::getSingleton('core/session')->addSuccess(Mage::helper('marketplace')->__('Your Product has been sucessfully updated'));
						$this->_redirect('marketplace/marketplaceaccount/myproductslist/');
					}else{
			...
			try {
				...
				if(count($collection_product)){
					if(empty($errors)){     
						...
						Mage::getSingleton('core/session')->addSuccess(Mage::helper('marketplace')->__('Your Product Is Been Successfully Updated'));
						$this->_redirect('marketplace/marketplaceaccount/myproductslist/');
					}else{
						foreach ($errors as $message) {Mage::getSingleton('core/session')->addError($message);}
