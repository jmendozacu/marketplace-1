 ...
 */
class Netzarbeiter_GroupSwitcher_Model_Rule_Type_TurnoverDaysGe
	extends Netzarbeiter_GroupSwitcher_Model_Rule_Type_TurnoverAbstract
{
	/**
	 * Check if the total turnover of the customers orders within the last N days are greater or equal then rule value.
	 *
