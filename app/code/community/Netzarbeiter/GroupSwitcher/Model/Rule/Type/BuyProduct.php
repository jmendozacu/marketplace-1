 ...
 */
class Netzarbeiter_GroupSwitcher_Model_Rule_Type_BuyProduct
	extends Netzarbeiter_GroupSwitcher_Model_Rule_Type_Abstract
{
	/**
	 * Return true is a product in the order matches the sku specified for the rule
	 *
